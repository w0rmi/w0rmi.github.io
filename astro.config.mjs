...
export default defineConfig({
  ...
  '/projects/project-boids': '/projects/BoidSimulationOpenGL',
  '/projects/project-croissant': '/projects/CroissantVulkanRenderer',
  '/projects/project-maze': '/projects/MazeCreator',
  '/projects/project-simpleRayTracer': '/projects/SimpleRayTracer',
  '/docs/sq-synth': '/docs/synthIntro'
} : {},
image: {
    service: {
