...
**Heeey!** I just moved to a new country with my wife and cat. There is a lot going on lately for us, but we're very happy with the new life so far. In order to relocate, I gave up my last job, and now we're completing all the boring paperwork needed after moving. Being a little bit more settled down in our new home, let's say that I've some time left to incursion into what I really wanted to for such a long period of time, which is **graphics drivers**!
...
> [!caution]
> With the way things are going in the world...I think it's important to clarify that you are/will be reading words from a human, not a machine... because I'm not and won't be using any LLMs to author my own words or code anything related to this series of blogs. I plan to study by understanding in depth, making my own connections, and really engaging with the field, in other words, doing my own thinking. My use of AI in this series of blogs can be described as an interactive [man page](https://en.wikipedia.org/wiki/Man_page) or a syntax checker, nothing more. Nevertheless, as a comment on a subreddit mentioned the other day, **don't let the AI steal your joy of doing what you like**.
